  ...
  <body id="pagina" class="text-center">
    ...
    <form class="form-signin">
        <div class="img-container">
          <img class="mb-4" src="./img/beatbox-logo-cropped.png" alt="">
        </div>
        <h1 class="h3 mb-3 font-weight-normal">Faça seu login</h1>
        <label for="inputEmail" class="sr-only">Endereço de email</label>
        <input type="email" id="inputEmail" class="form-control" placeholder="Endereço de email" required autofocus oninvalid="this.setCustomValidity('Por favor, coloque seu email')">
